...
{
    public class InvItemTransactionMasterUpdateDto
    {
        public InvItemTransactionMasterUpdateDto()
        {
            TransactionDetails = new List<InvItemTransactionDetailsUpdateDto>();
        ...
        public ICollection<InvItemTransactionDetailsUpdateDto> TransactionDetails { get; set; }
        public ICollection<InvItemTransactionDetailsUpdateDto>? TransactionDetailsFinishedGoods { get; set; }
    }

    public class InvItemTransactionDetailsUpdateDto
    {
        public Guid Id { get; set; }
